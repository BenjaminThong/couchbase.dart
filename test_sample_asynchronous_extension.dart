...
import 'lib/sample_asynchronous_extension.dart';
...
main() async {
  ...
  print('11111');
  List<int> list_100 = await r.randomArray(17, 10000);
  print('222222');
  List<int> list_200 = await r.randomArray(17, 20000);
  print('333333');
  for (var i = 0; i < 100; ++i) {
//    print('444444 ${list_100[i]} ${list_200[i]}');
